...
<head>
    ...
    <title>Prestamo de Cubículo Grupal</title>
    <style>
        body {
...
<body>
    <header>
        <h1>Registro de Préstamo de Cubículo Grupal</h1>
    </header>

    <form id="prestamoForm">
        <div id="userInfo">
            <div id="infoUsuario">
                <!-- Quitar readonly para permitir la edición del usuario responsable -->
        ...
        <!-- La fecha se carga automáticamente por el sistema -->
        <input type="hidden" id="fechaRegistro" name="fechaRegistro" value="2023-11-27">

        <!-- La hora se sugiere automáticamente pero es modificable por el usuario -->
        <label for="horaInicio">Hora de Inicio:</label>
        <input type="text" id="horaInicio" name="horaInicio" value="10:00">

        <button type="submit">Registrar Préstamo</button>
        <button type="button" onclick="mostrarPrestamos()">Ver Préstamos</button>
    </form>
